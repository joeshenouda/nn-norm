...
#
thr=0.00005
logger_name="pn_w2v1_loss_{$thr}_{$lr}_SGD"
#python main.py --cuda --gpu $n_gpu --logger-name $logger_name --config $config_name --algo v0 --lr $lr --threshold $thr --regularize --with-loss-term --loss-term pn --w-norm-degree 2 --v-norm-degree 1 &
#
thr=0.00003
logger_name="pn_w2v1_loss_{$thr}_{$lr}_SGD"
#python main.py --cuda --gpu $n_gpu --logger-name $logger_name --config $config_name --algo v0 --lr $lr --threshold $thr --regularize --with-loss-term --loss-term pn --w-norm-degree 2 --v-norm-degree 1 &
